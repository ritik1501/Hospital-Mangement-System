...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> Corona Hospital</a>
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab" aria-controls="messages">Patient Details</a>
    ...
    <div class="tab-content" id="nav-tabContent">
      ...
      <thead>
        <tr>
          ...
          <th scope="col">Doctor Appoint</th>
